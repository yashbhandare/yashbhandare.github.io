import {Box, Flex, Heading, IconButton, useColorModeValue, VStack, Image, Text, HStack} from "@chakra-ui/react";
import {Link} from "react-router-dom";
import {FaAmazon, FaFacebook, FaInstagram, FaSpotify, FaYoutube} from "react-icons/fa";
          ...
          <HStack justifyContent="space-around" width={"100%"}>
              <VStack>
                  ...
                  <Flex gap={4} justify="center">
                      ...
                      <Link to="https://open.spotify.com/artist/2kBeVVi1RkSz4yjOM1dkKc?si=P1ctVaD5SeCYRu4PX08Qyw&nd=1&dlsi=d6ac75a204db47a2" isExternal>
                          <IconButton
                              icon={<FaSpotify />}
                              aria-label="Spotify"
                              size="lg"
                      ...
                      <Link to="https://music.amazon.in/artists/B09W66FHZX?marketplaceId=A3K6Y4MI8GDYMT&musicTerritory=IN&ref=dm_sh_9LxhNRIFMVTxQSXlbU7hu6eRg" isExternal>
                          <IconButton
                              icon={<FaAmazon />}
